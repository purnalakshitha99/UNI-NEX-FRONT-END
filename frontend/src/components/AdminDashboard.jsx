    ...
    return (
        <div className="min-h-screen bg-[#020617] flex font-sans overflow-hidden">
            ...
            <main className="flex-1 p-4 pt-24 sm:p-6 sm:pt-24 lg:ml-72 lg:p-12 lg:pt-12 overflow-y-auto">
                {/* Header section */}
                <header className="mb-10 flex flex-col gap-4 sm:mb-12 sm:flex-row sm:items-center sm:justify-between animate-fade-in">
                    <div>
                    ...
                    <div className="flex gap-3 sm:gap-4">
                        ...
                        <button className="bg-blue-600 text-white font-black text-[10px] uppercase tracking-widest px-5 sm:px-8 py-3.5 rounded-2xl shadow-lg shadow-blue-600/20 hover:scale-105 active:scale-95 transition-all whitespace-nowrap">
                            Export Report
                        </button>
                    </div>
                </header>
